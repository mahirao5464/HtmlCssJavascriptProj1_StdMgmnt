...
function addStudent() {
  ...
  fetch("https://crudcrud.com/api/1278901d462c48f2a3c6cdef451f1adc/Students")
...
function renderTable(el) {
  ...
  let rowTemplate = `<tr id='row-${el._id}'>
              ...
              <td>
                <button type="button" class="btn btn-primary btn-sm"  data-bs-toggle="modal" data-bs-target="#editModal"  id="editStudent${el._id}" onclick="showEditModal(this)" student-index = "${el._id}">Edit</button>
...
async function deleteStudent(studentId) {
  ...
  if (isConfirmed) {
    fetch(
      "https://crudcrud.com/api/1278901d462c48f2a3c6cdef451f1adc/Students/" +
        studentId,
      {
        method: "DELETE",
      }
